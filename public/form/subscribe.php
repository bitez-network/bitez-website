...
$emailTO[] = array( 'email' => 'bas@bitez.network', 'name' => 'The Entropy Team' ); 
...
### Enter Email Subject
$subject = "Contact Me Notification" . ' - ' . $sitename; 
...
### Success Messages
$msg_success = "<strong>Thank you.</strong> We'll get back to you in 24 hours!";
